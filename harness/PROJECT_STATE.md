...
把所有 automated mechanism trace 与复杂牌组复核合并后，当前覆盖报告为 586 张目录牌、363 张 trace-observed、
361 张产生账本事件；223 张尚未观察到，其中 207 张是 generated-only、16 张是
historical/runtime-missing，已经没有直接可构筑但未观察到的牌。`草与智慧`、`以极限之名`、`赤王陵`、`噬骸能量块`、`亡雷凝蓄`、`夜域赐礼·索报皆偿`
